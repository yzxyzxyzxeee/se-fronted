...
export const getStaffByName = config => request._get(testAPI.STAFF_NAME,config);
export const ediePas = config => request._post(testAPI.STAFF_PAW,config);
export const getPerformanceByname = config => request._get(testAPI.PERFORMANCE_STAFF,config);